...
private static Context aContext=null;
    ...
    /**
     * Checks for Accelrometer support,Returns true if at least one Accelerometer sensor is available
     */
    ...
    private static SensorEventListener sensorEventListener = 
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (lastUpdate == 0) {
                ...
                lastY = y;
                lastZ = z;
              //st.makeText(aContext,"No Motion detected", Toast.LENGTH_SHORT).show();
